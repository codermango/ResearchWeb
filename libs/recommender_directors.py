...
def recommend(user_liked_movieid_list):
    ...
    movieid_with_directorid_file = open(os.path.split(os.path.realpath(__file__))[0] + '/imdbdirectors.json')
    ...
    sum_of_every_directorid_dict = get_sum_of_every_directorid_dict(os.path.split(os.path.realpath(__file__))[0] + '/directorid_with_imdbid.json')
